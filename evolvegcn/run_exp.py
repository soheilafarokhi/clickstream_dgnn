...
def build_dataset(args):
    if args.data == 'click_stream':
        return cs.Click_Stream_Dataset(args)
    else:
...
def build_gcn(args, tasker):
    ...
    elif args.model == 'egcn_h_lstm':
        return egcn_h_l.EGCN_LSTM(gcn_args, activation=torch.nn.RReLU(), device=args.device)
    elif args.model == 'egcn_h_gru':
        return egcn_h_l.EGCN_LSTM(gcn_args, activation=torch.nn.RReLU(), device=args.device, use_gru=True)
    ...
    #     return egcn_h.EGCN(gcn_args, activation=torch.nn.RReLU(), device=args.device, skipfeats=True)
        ...
        return simple_gcn_lstm.GCN_LSTM(gcn_args, activation=torch.nn.RReLU(), device=args.device)
    elif args.model == 'gcn_lstm':
        return simple_gcn_lstm.GCN_LSTM(gcn_args, activation=torch.nn.RReLU(), device=args.device, use_gru=True)
    elif args.model == 'lstmB':
        return mls.Sp_GCN_LSTM_B(gcn_args, activation=torch.nn.RReLU()).to(args.device)
    elif args.model == 'gruB':
        return mls.Sp_GCN_GRU_B(gcn_args, activation=torch.nn.RReLU()).to(args.device)
...
if __name__ == '__main__':
    ...
    cross_entropy = ce.Cross_Entropy(args, dataset, tasker.num_classes).to(args.device)
