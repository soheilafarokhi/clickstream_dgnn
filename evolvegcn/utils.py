...
def parse_args(parser):
    ...
    args.gcn_parameters['cls_l2_feats'] = random_param_value(args.gcn_parameters['cls_l2_feats'],
                                                          args.gcn_parameters['cls_l2_feats_min'],
                                                          args.gcn_parameters['cls_l2_feats_max'], type='int')
