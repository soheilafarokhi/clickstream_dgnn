...
command_template = "/home/soha/.virtualenvs/clicktream/bin/python lstm_model.py --course {} --num_weeks {} --learning_rate {} --dropout {} --hidden_dim {} --num_layers {} --epochs {} --fcn_dim {}"
i = 1
process_states = []
